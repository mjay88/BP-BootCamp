  ...
  return (
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route path="tennesse-whiskey" element={<div>Tennesse Whiskey</div>} />
        <Route
        ...
        <Route path="history-of-Pisco" element={<div>History of Pisco</div>} />
        <Route
        ...
        />
        <Route path="tequila" element={<div>Tequila, go fuck yourself</div>} />
        <Route
        ...
        <Route path="whiskey-liqueurs" element={<div>whiskey liqueurs</div>} />
        <Route
        ...
        />
        <Route path="aromatized-wines" element={<div>aromatized wines</div>} />
        <Route
