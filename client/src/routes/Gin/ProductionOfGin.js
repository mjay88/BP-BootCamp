...
export default function ProductionOfGin() {
	return (
		<div className="flex flex-col py-4 px-4">
			<h1 className="flex justify-center my-5 text-lg">Production of Gin</h1>
			...
			<div className="flex flex-col lg:grid grid-cols-4 gap-3">
				...
				<div className="flex-1  lg:col-span-2 row-span-3">
					<img className="object-contain" src={VodkaBottles} />
				</div>
				<div className="flex-1 lg:col-span-2">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita,
					placeat reprehenderit accusamus architecto hic, quisquam provident
					sequi veritatis minus sit alias iste quod suscipit dicta harum quaerat
					adipisci itaque culpa!
				</div>
				...
				<div className="flex-1 lg:col-span-4">
					...
					placeat reprehenderit accusamus architecto hic, quisquam provident
					sequi veritatis minus sit alias iste quod suscipit dicta harum quaerat
					adipisci itaque culpa! Lorem ipsum dolor sit amet consectetur
					adipisicing elit. Expedita, placeat reprehenderit accusamus architecto
					hic, quisquam provident sequi veritatis minus sit alias iste quod
					suscipit dicta harum quaerat adipisci itaque culpa!
				</div>
