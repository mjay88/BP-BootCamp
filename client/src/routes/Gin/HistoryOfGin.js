...
export default function HistoryOfGin() {
	return (
		<div className="flex flex-col py-4 px-4">
			<h1 className="flex justify-center my-5 text-lg">History of Gin</h1>
